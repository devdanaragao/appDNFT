//
//  ListOffersTableViewTableViewCell.swift
//  appDNFT
//
...
class ListOffersTableViewCell: UITableViewCell {
    ...
    private lazy var screen: ListOffersTableScreen = {
        let view = ListOffersTableScreen()
    ...
    public func setupCell(data: LatestDeal, isInicial: Bool, isFinal: Bool) {
        ...
        screen.nftPriceLabel.text = "\(data.nftPrice ?? 0) EURO"
